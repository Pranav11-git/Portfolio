...
Implemented dynamic playback/download, managed CORS and API communication.`} gitLink={"https://github.com/Pranav11-git/binaural-frontend"}/>
            <ProjectsCard title={"Password generator"} image={"/assets/Screenshot from 2025-10-23 11-57-57.png"} description={`Built a responsive password generator with customization options.
